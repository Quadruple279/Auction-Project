...
public class ItemDAO {
    public void save(Item item) throws SQLException {
        String sql = "INSERT INTO items (id,name,base_price,description,item_type,sellerName," +
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            pstmt.setString(6, item.getSellerName());
    ...
    private Item mapRowToItem(ResultSet rs) throws SQLException {
        ...
        return switch (item_type) {
            case "ART" -> new Art(id, name, base_price, des, sellerName, artist);
            case "VEHICLE" -> new Vehicle(id, name, base_price, des, sellerName, car_year, bien_so_xe);
            case "ELECTRONICS" -> new Electronics(id, name, base_price, des, sellerName, wm);
